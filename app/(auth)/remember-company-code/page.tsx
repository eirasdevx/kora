...
export default function RememberCompanyCodePage() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!normalizedIdentifier) {
      setError("Introduce tu DNI o correo.");
      setInfo(null);
      return;
    }
    ...
    try {
      const response = await fetch("/api/auth/company-codes", {
        method: "POST",
        headers: {
      ...
      const payload = await parseApiResponse<CompanyCodeResponse>(response);
